...
public class PohadjanjePredmeta {
    ...
    private List<PrijavaPrestupa> prijave = new ArrayList<>();
	...
	public PohadjanjePredmeta(Long id, int ocena, int brojPolaganja, boolean aktivan, LocalDateTime datumPocetka,
			LocalDateTime datumZavrsetka, Student student, Predmet predmet, List<PrijavaPrestupa> prijave,
			List<EvaluacijaZnanja> evaluacije) {
		super();
		this.id = id;
		this.ocena = ocena;
	...
	public List<PrijavaPrestupa> getPrijave() {
		return prijave;
	}

	public void setPrijave(List<PrijavaPrestupa> prijave) {
		this.prijave = prijave;
	}
