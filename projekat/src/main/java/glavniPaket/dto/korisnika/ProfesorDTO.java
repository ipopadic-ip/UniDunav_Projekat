...
public class ProfesorDTO extends RegistrovaniKorisnikDTO {
    ...
    public ProfesorDTO(Integer id, String ime, String prezime, String korisnickoIme, Date datumRodjenja,
                       MestoDTO mestoRodjenja, String jmbg, String email, String titula, String biografija,
    ...
    public static ProfesorDTO fromEntity(Profesor profesor) {
        if (profesor == null || profesor.getKorisnik() == null) return null;
        ...
        return new ProfesorDTO(
            ...
            k.getEmail(),
            profesor.getTitula(),
            profesor.getBiografija(),
            profesor.getPredmeti() != null
                ? profesor.getPredmeti().stream()
